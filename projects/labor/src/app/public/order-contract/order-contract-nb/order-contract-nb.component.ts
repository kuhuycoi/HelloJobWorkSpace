...
@Component({
  selector: 'app-order-contract-nb',
  templateUrl: './order-contract-nb.component.html',
  styleUrls: ['./order-contract-nb.component.scss'],
})
export class OrderContractNbComponent implements OnInit {
