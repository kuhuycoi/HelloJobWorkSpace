...
@Component({
  selector: 'app-order-contract-dl',
  templateUrl: './order-contract-dl.component.html',
  styleUrls: ['./order-contract-dl.component.scss'],
})
export class OrderContractDlComponent implements OnInit {
