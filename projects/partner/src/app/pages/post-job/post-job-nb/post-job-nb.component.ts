...
@Component({
  selector: 'app-post-job-nb',
  templateUrl: './post-job-nb.component.html',
  styleUrls: ['./post-job-nb.component.scss'],
  providers: [
...
export class PostJobNbComponent implements OnInit, AfterViewInit {
  ...
  form: FormGroup = new FormGroup({
    ...
    contractType: new FormControl('NB'),
