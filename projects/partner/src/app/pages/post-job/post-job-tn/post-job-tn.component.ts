...
@Component({
  selector: 'app-post-job-tn',
  templateUrl: './post-job-tn.component.html',
  styleUrls: ['./post-job-tn.component.scss'],
  providers: [
...
export class PostJobTnComponent implements OnInit, AfterViewInit {
  ...
  form: FormGroup = new FormGroup({
    ...
    profileRequired: new FormControl(null),
    insuranceInfo: new FormControl(null)
  });
