...
import { UserReport } from 'projects/tools/src/lib/types/user-report';

@Component({
  selector: 'app-customer-wish',
  templateUrl: './customer-wish.component.html',
  styleUrls: ['./customer-wish.component.scss']
})
export class CustomerWishComponent implements OnInit {
  ...
  constructor(
    ...
    private router: Router, private publicService: PublicService,
    ...
    route.queryParams.subscribe((params: Params) => {
      ...
      if (keyword) {
        this.pager.keyword = decodeURI(keyword);
      }
  ...
  paging() {
    ...
    this.publicService.pagerCustomerWish(params).subscribe((res: ResponsePaging) => {
  ...
  reload() {
    ...
    this.router.navigate(['/lao-dong-tim-viec'], { queryParams: params });
  }
  isSaved(id) {
